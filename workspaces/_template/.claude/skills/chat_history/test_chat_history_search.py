...
Run:  python3 -m pytest .claude/skills/chat_history/test_chat_history_search.py -v
  or: python3 -m unittest .claude/skills/chat_history/test_chat_history_search -v
"""
